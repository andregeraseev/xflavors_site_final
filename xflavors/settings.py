# xflavors/settings.py
"""

Django settings for xflavors project.
...
MIDDLEWARE = [
    ...
    'xflavors.middlewares.RedirectToHomepageMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'xflavors.context_processors.categorias',
...
WSGI_APPLICATION = 'xflavors.wsgi.application'
...
STATICFILES_STORAGE = 'xflavors.settings.WhiteNoiseStaticFilesStorage'
